(function () {
    ...
    onClick('options-apply2', function () {
    ...
    function optionsPaneUpdate(options) {
        document.getElementById('chunks-count2').value = options.chunksCount;
        document.getElementById('queue-cap2').value = options.queueCapacity;
    }

    function optionsPaneRead() {
        return {
            chunksCount: +document.getElementById('chunks-count2').value,
            queueCapacity: +document.getElementById('queue-cap2').value
        };
    }
